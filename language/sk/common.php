...
$lang = array_merge($lang, array(
	...
	'CONFIRM_CODE_EXPLAIN'	=> 'Vložte overovací kód presne ako ho vidíte na obrázku, na veľkosti písma nezáleží. Nula v obrázkoch je preškrtnutá šikmou čiarou.',
  ...
  'KIB'					=> 'KiB',
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> 'Pre zabránenie vytvárania registrácií botmi, administrátor vyžaduje potvrdenie registrácie zadaním kódu, ktorý je zobrazovaný v obrázku nad okienkom do ktorého treba tento kód prepísať. Ak je tento kód nečitateľný, kontaktujte %sAdministrátora fóra%s.',
	'LOGIN_ERROR_ATTEMPTS'				=> 'Prekročili ste maximálny počet pokusov pre prihlásenie k Vášmu účtu, pre prihlásenie musíte zadať aj overovací kód, vyobrazený nižšie.',
