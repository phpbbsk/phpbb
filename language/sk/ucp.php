...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_ADDED'					=> 'Ďakujeme za registráciu, váš účet bol vytvorený.',
	...
	'ACCOUNT_INACTIVE'				=> 'Váš účet bol vytvorený. Tento portál však vyžaduje dodatočnú aktiváciu. Aktivačný kľúč vám bol odoslaný na zadanú emailovú adresu, prosím skontrolujte si emailovú schránku a tiež spam priečinok. Prijatie emailu môže chvíľu trvať, v závislosti od vášho emailového poskytovateľa.',
	...
	'ATTACHMENT_LOCKED'				=> 'Táto téma je zamknutá, nemôžete vymazať jej prílohu.',
	...
	'AVATAR_DRIVER_GRAVATAR_EXPLAIN'=> 'Gravatar je služba, ktorá umožňuje použiť rovnaký obrázok naprieč spektrom rôznych webstránok. Viac informácií na <a href="http://www.gravatar.com/">Gravatar</a> webe.',
	...
	'BOARD_DATE_FORMAT_EXPLAIN'	=> 'Pužitý syntax je identický s funkciou <a href="https://secure.php.net/manual/function.date.php">date()</a> jazyka PHP.',
	...
	'GRAVATAR_AVATAR_EMAIL_EXPLAIN'	=> 'Vložte e-mailovú adresu, ktorú ste použili pri registrácii na <a href="http://www.gravatar.com/">Gravatar</a>.',
	...
	'NOTIFICATION_METHOD_BOARD'							=> 'Notifikácia',
	...
	'NOTIFICATION_TYPE_FORUM'							=> 'Niekto odpovie v téme vo fóre, ktoré sledujete',
	...
	'NOTIFICATION_TYPE_REPORT_CLOSED'					=> 'Vaša sťažnosť na príspevok je uzatvorená moderátorom',
	'NOTIFICATION_TYPE_REPORT_PM'						=> 'Niekto podal sťažnosť na súkromnú správu',
	'NOTIFICATION_TYPE_REPORT_PM_CLOSED'				=> 'Vaša sťažnosť na súkromnú správu bola uzavretá moderátorom',
	...
	'NO_AUTH_PRINT_MESSAGE'			=> 'Nemáte dostatočné oprávnenie na vytlačenie súkromnej správy.',
	...
	'NO_RESET_TOKEN'			=> 'Neposkytli ste token na zresetovanie hesla.',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Heslo musí mať najmenej %1$s, musí obsahovať malé a veľké písmená a musí obsahovať aj čísla.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Heslo musí mať najmenej %1$s.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Heslo musí mať najmenej %1$s, musí obsahovať malé a veľké písmená.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Heslo musí mať najmenej %1$s, musí obsahovať malé a veľké písmená, číslice a symboly.',
	'PASSWORD'					=> 'Heslo',
	'PASSWORD_ACTIVATED'		=> 'Nové heslo bolo aktivované.',
	'PASSWORD_RESET'			=> 'Vaše heslo bolo úspešne zresetované.',
	'PASSWORD_RESET_LINK_SENT'	=> 'Ak váš účet exituje, odkaz na zresetovanie hesla bol poslaný na váš email. Ak email neprišiel, môže to byť preto, že ste zabanovaný, váš účet je neaktitovaný, požiadali ste o príliš veľa zresetovaní hesla v krátkom čase, alebo nemáte oprávnenie zmeniť heslo. Ak niečo z toho platí, kontaktujte administrátora. Skontrolute si však aj SPAM.',
	...
	'PM_NO_USERS'				=> 'Používateľ nenájdený.',
	...
	'OAUTH_REGISTRATION'				=> 'Registrácia pomocou externej služby',
	...
	'RESET_TOKEN_EXPIRED_OR_INVALID'	=> 'Tokan na zresetovanie hesla, ktorý ste poskytli, je neplatný alebo už zastaralý.',
