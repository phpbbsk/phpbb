...
$help = array(
	...
	array(
		0 => 'Vkladanie príloh',
		1 => 'Prílohy je teraz možné pridávať do príspevku priemo pri jeho písaní použitím párového tagu <strong>[attachment=][/attachment]</strong>, ak bol tento párový tag povolený administrátorom portálu a ak autor príspevku disponuje príslušným oprávnením k vkladaniu príloh.'
	),
	array(
		0 => '--',
		1 => 'Iné'
	...
	array(
		...
		1 => 'Ak ste administrátor tohto fóra a máte dostatočné oprávnenia, môžete pridať nové BBCode cez modul Vlastné BBCode.'
	),
);
