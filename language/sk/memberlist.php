...
$lang = array_merge($lang, array(
	...
	'FIND_USERNAME_EXPLAIN'	=> 'Použite tento formulár na vyhľadanie používateľa. Nemusíte vyplniť všetky polia. Môžete použiť * ako zástupný symbol. Ak vkladáte dátumy použite formát <kbd>YYYY-MM-DD</kbd>, napríklad <samp>2015-02-20</samp>. Použite zaškrtávacie políčka, ak chcete zvoliť viacerých používateľov.',
	...
	'IM_JABBER_SUBJECT'		=> 'Toto je automaticky vygenerovaná správa, neodpovedajte na ňu! Správa od používateľa %1$s %2$s.',
	'IM_MESSAGE'			=> 'Vaša správa',
	'IM_NAME'				=> 'Vaše meno',
	'IM_NO_DATA'			=> 'Pre tohoto používateľa nie sú kontaktné informácie k dispozícii.',
	'IM_NO_JABBER'			=> 'Prepáčte, priame odosielanie správ používateľov Jabberu nie je týmto portálom podporované.',
	'IM_RECIPIENT'			=> 'Príjemca',
	'IM_SEND'				=> 'Odoslať správu',
	'IM_SEND_MESSAGE'		=> 'Odoslať správu',
	'IM_SENT_JABBER'		=> 'Vaša správa používateľovi %1$s bola odoslaná.',
	...
	'LOGIN_EXPLAIN_MEMBERLIST'	=> 'Portál vyžaduje, aby ste boli zaregistrovaný a prihlásený, ak chcete mať prístup k zoznamu používateľov.',
	'LOGIN_EXPLAIN_SEARCHUSER'	=> 'Portál vyžaduje, aby ste boli zaregistrovaný a prihlásený, ak chcete vyhľadať používateľov.',
	...
	'NO_EMAIL'				=> 'Nemáte dostatočné oprávnenia na odoslanie emailu tomuto používateľovi.',
	...
	'USERNAME_BEGINS_WITH'	=> 'Používateľské meno začína na',
	'USER_ADMIN'			=> 'Spravovať používateľa',
	'USER_BAN'				=> 'Udeliť ban',
	'USER_FORUM'			=> 'Štatistiky používateľa',
	...
	'USERS_PER_PAGE'		=> 'Používateľov na stránku',

	'VIEWING_PROFILE'		=> 'Profil používateľa - %s',
