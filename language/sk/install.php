...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Práve ste úspešne uskutočnili prechod Vášho fóra na verziu phpBB3. Teraz sa môžete prihlásiť a <a href="../">vstúpiť do svojho fóra</a>. Skôr než zmažete zložku /install uistite sa, že všetky dáta boli prenesené v poriadku. Nezabudnite, že podpora pre phpBB3 je dostupná na internete formou <a href="https://www.phpbb.com/support/docs/en/3.1/ug/">Užívateľskej príručky</a> alebo prostredníctvom <a href="https://www.phpbb.com/community/viewforum.php?f=466">fóra podpory.</a>',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		...
		<p>Kliknutím na tlačítko nižšie sa dostanete do administrácie phpBB (ACP). Urobte si chvíľu čas a porozhliadnite sa, aké možnosti vám phpBB3 ponúka. Online podpora je dostupná cez <a href="https://www.phpbb.com/support/docs/en/3.1/ug/">Dokumentáciu</a> a <a href="https://www.phpbb.com/community/viewforum.php?f=466">phpBB.com fórum (Anglicky)</a>, taktiež si pozrite <a href="%3$s">README</a> pre ďalšie informácie.</p><p><strong>Teraz prosím zmažte, presuňte alebo premenujte zložku install. Pokiaľ táto zložka nebude odstránená, bude funkčná len administrácia fóra (ACP).</strong>',
    ...
    'MYSQL_SCHEMA_UPDATE_REQUIRED'	=> 'Schéma vašej MySQL databázy pre phpBB je neaktuálna. phpBB detekovalo schému pre MySQL 3.x/4.x, ale server používa MySQL %2$s.<br /><strong>Ak budete pokračovať s aktualizáciou, musíte aktualizovať najprv schému.</strong><br /><br />Pozrite sa na <a href="https://www.phpbb.com/kb/article/doesnt-have-a-default-value-errors/">článok v databáze phpBB.com o aktualizácií</a>. Pokiaľ narazíte na problém, obráťte sa na <a href="https://www.phpbb.com/community/viewforum.php?f=466">fórum podpory phpBB.com</a>.',
	...
	'PHP_JSON_SUPPORT_EXPLAIN'		=> '<strong>Povinné</strong> - Aby phpBB pracovalo správne, PHP JSON rozšírenie musí byť dostupné.',
	...
	'SELECT_FORUM_GA'			=> 'V phpBB 3.1 sú globálne oznámenia prepojené k fóram. Vyberte fórum, kde sú momentálne vaše globálne oznámenia (dajú sa presunúť aj neskôr):',	
    ...
    'SUPPORT_BODY'				=> 'Plná podpora bude poskytovaná pre aktuálnu stabilnú verziu phpBB3, zdarma. To obsahuje:</p><ul><li>inštaláciu</li><li>nastavenie</li><li>technické otázky</li><li>vysvetlenie problémov k potentencionálnym chybám v software</li><li>aktualizácia z nestabilných verzií (RC) na najnovšie verzie</li><li>konverziou z phpBB 2.0.x na phpBB3</li><li>konverziou z iných diskusných systémov na phpBB3 (prosím pozrite na <a href="https://www.phpbb.com/community/viewforum.php?f=486">Convertors Forum</a>)</li></ul><p>Doporučujeme užívateľom bežiacich na RC verziách phpBB3, aby nahradili staré súbory novou verziou.</p><h2>MODy / Štýly</h2><p>Pri problémoch s MODmi, prosím píšte do <a href="https://www.phpbb.com/community/viewforum.php?f=451">Extensions Forum</a>.<br />Pri problémoch so štýlmi, templatmi a sadami obrázkov, prosím píšte do <a href="https://www.phpbb.com/community/viewforum.php?f=471">Styles Forum</a>.<br /><br />Ak vaša otázka vyžaduje špeciálnu prílohu, prosím pošlite priamo do sekcie aj prílohu.</p><h2>Obdržanie podpory</h2><p><a href="https://www.phpbb.com/community/viewtopic.php?f=14&amp;t=571070">The phpBB uvítací balíček</a><br /><a href="https://www.phpbb.com/support/">Support Section</a><br /><a href="https://www.phpbb.com/support/docs/en/3.1/ug/quickstart/">Príručka pre rýchly štart</a><br /><br />Pre zaistenie najnovšej verzie <a href="https://www.phpbb.com/support/">začiarknite náš mailing zoznam</a>?<br /><br />',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Všetky súbory sú zhodné s najnovšou verziou phpBB.',
	...
	'NO_UPDATE_FILES_OUTDATED'		=> 'Nebola nájdená zložka pre aktualizáciu, uistite sa, že ste nahrali zodpovedajúce aktualizačné súbory.<br /><br />Na vašom fóre <strong>nepoužívate</strong> poslednú verziu phpBB. Aktualizácie sú dostupné pre vašu verziu phpBB %1$s, prosím navštívte <a href="https://www.phpbb.com/downloads/" rel="external">http://www.phpbb.com/downloads.php</a> pre stiahnutie správneho balíčku pre aktualizáciu z verzie %2$s na verziu %3$s.',
	...
	'SHOW_DIFF_DELETED'			=> 'Zobraziť obsah súboru',
	...
	'UPDATE_FILE_SUCCESS'			=> 'Aktualizácia súboru bola úspešná.',
