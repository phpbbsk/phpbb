...
$lang = array_merge($lang, array(
	...
	'ACP_BAN_USERNAMES'			=> 'Ban používateľských mien',
	'ACP_BBCODES'				=> 'BB kódy',
	...
	'ACP_MANAGE_USERS'			=> 'Spravovať používateľov',
	...
	'ACP_REGISTER_SETTINGS'		=> 'Nastavenia registrácie používateľov',
	...
	'ACP_USERS_FORUM_PERMISSIONS'	=> 'Používateľské oprávnenia fór',
	'ACP_USERS_LOGS'				=> 'Používateľský záznam',
	...
	'ACP_VIEW_USER_PERMISSIONS'			=> 'Zobraziť oprávnenia založené na používateľoch',
	...
	'LOGIN_ADMIN'			=> 'Pre správu fóra musíte byť prihlásený a oprávnený používateľ.',
	...
	'NO_FILES_TO_DELETE'	=> 'Prílohy, ktoré ste označili na vymazanie neexistujú.',
	...
	'PERMISSIONS_TRANSFERRED_EXPLAIN'	=> 'Teraz máte oprávnenia %1$s. Môžete prechádzať fórum s používateľským oprávnením, ale nemôžete vstúpiť do administrácie fóra, pretože administrátorské oprávnenia neboli prenesené. Môžete sa kedykoľvek <a href="%2$s"><strong>vrátiť k vašim oprávneniam</strong></a>.',
	...
	'TASKS_NOT_READY'			=> 'Nepripravené úlohy:',
	'TASKS_READY'			=> 'Pripravené úlohy:',
...
$lang = array_merge($lang, array(
	...
	'ACP_MOD_LOGS_EXPLAIN'		=> 'Tento záznam vypisuje všetky činnosti vykonané na fórach, témach a príspevkoch, tak isto ako akcie vykonané na používateľoch moderátormi, vrátane banovania. Môžete ich zoradiť podľa mena, dátumu, IP, alebo akcie. Pokiaľ máte príslušné oprávnenia, môžete zmazať jednotlivé záznamy, alebo celý záznam.',
	'ACP_USERS_LOGS_EXPLAIN'	=> 'Toto vypisuje všetky činnosti uskutočnené používateľom, alebo na používateľoch (oznámenia, varovania a používateľské poznámky).',
...
$lang = array_merge($lang, array(
	...
	'NO_SEARCH_INDEX'	=> 'Vybraný vyhľadávací backend nemá vyhľadávací index.<br />Prosíme, vytvorte index pre “%1$s” v sekcii %2$svyhľadávací index%3$s.',
	...
	'PURGE_SESSIONS_CONFIRM'	=> 'Naozaj chcete zmazať všetky sessions? Zmazaním odhlásite všetkych používateľov.',
	'PURGE_SESSIONS_EXPLAIN'	=> 'Odstráni všetky sessions a odhlási všetkych používateľov prečistením ich databázovej tabuľky.',
	'PURGE_SESSIONS_SUCCESS'	=> 'Sessions úspešne odstránené.',

	'RESET_DATE'					=> 'Resetovať dátum spustenia fóra',
	'RESET_DATE_CONFIRM'			=> 'Naozaj chcete vynulovať dátum založenia fóra?',
	'RESET_DATE_SUCCESS'				=> 'Dátum založenia fóra vynulovaný',
	'RESET_ONLINE'					=> 'Resetovať rekord online používateľov',
	'RESET_ONLINE_CONFIRM'			=> 'Naozaj chcete vynulovať počítadlo rekordu naraz prítomných používateľov?',
	'RESET_ONLINE_SUCCESS'				=> 'Počítadlo rekordu používateľov vynulované',
	...
	'RESYNC_POSTCOUNTS_SUCCESS'			=> 'Počty príspevkov resynchronizované',
	...
	'RESYNC_POST_MARKING_EXPLAIN'	=> 'Najskôr odznačí všetky témy, a potom správne označí tie, v ktorých používateľ vykázal aktivitu v posledných šiestich mesiacoch.',
	'RESYNC_POST_MARKING_SUCCESS'	=> 'Označené témy resynchronizované',
	...
	'RESYNC_STATS_SUCCESS'			=> 'Štatistiky resynchronizované',
	'RUN'							=> 'Spustiť teraz',

	'STATISTIC'					=> 'Štatistika',
	'STATISTIC_RESYNC_OPTIONS'	=> 'Resynchronizovať, alebo vynulovať štatistiky',

	'TIMEZONE_INVALID'	=> 'Vami vybraná časová zóna je neplatná.',
	'TIMEZONE_SELECTED'	=> '(momentálne označená)',
	...
	'VERSIONCHECK_INVALID_ENTRY'	=> 'Informácie z poslednej verzie obsahujú nepodporované prvky.',
	'VERSIONCHECK_INVALID_URL'		=> 'Informácie z poslednej verzie obsahujú neplatnú URL adresu.',
	'VERSIONCHECK_INVALID_VERSION'	=> 'Informácie z poslednej verzie obsahujú neplatnú verziu.',
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN'		=> 'Toto je zoznam používateľov, ktorí sa registrovali, ale ich účty nie sú aktívne. Môžete aktivovať, zmazať alebo upozorniť (odoslaním e-mailu) týchto používateľov, pokiaľ chcete.',
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'Toto je zoznam posledných 10 registrovaných používateľov, ktorí majú neaktívne účty. Účty sú neaktívne buď pretože aktivácia účtu bola povolená v nastaveniach registrácie a účty týchto používateľov ešte neboli aktivované, alebo pretože tieto účty boli deaktivované. Celý zoznam je dostupný na odkaze nižšie, skadiaľ môžete aktivovať, vymazať alebo upozorniť (poslaním emailu) týchto používateľov ak si prajete.',
...
// Log Entries
$lang = array_merge($lang, array(
	'LOG_ACL_ADD_USER_GLOBAL_U_'		=> '<strong>Pridané alebo upravené používateľské oprávnenie používateľa</strong><br />» %s',
	'LOG_ACL_ADD_GROUP_GLOBAL_U_'		=> '<strong>Pridané alebo upravené používateľské oprávnenie skupiny</strong><br />» %s',
	'LOG_ACL_ADD_USER_GLOBAL_M_'		=> '<strong>Pridané alebo upravené globálne moderátorské oprávnenie používateľa</strong><br />» %s',
	'LOG_ACL_ADD_GROUP_GLOBAL_M_'		=> '<strong>Pridané alebo upravené globálne moderátorské oprávnenie skupiny</strong><br />» %s',
	'LOG_ACL_ADD_USER_GLOBAL_A_'		=> '<strong>Pridané alebo upravené administrátorské oprávnenie používateľa</strong><br />» %s',
	...
	'LOG_ACL_DEL_FORUM_LOCAL_F_'		=> '<strong>Odstránené používateľské/skupinové oprávnenia k fóru</strong> od %1$s<br />» %2$s',
	...
	'LOG_ATTACHMENTS_DELETED'   => '<strong>Zmazané prílohy používateľa</strong><br />» %s',
	...
	'LOG_BAN_EXCLUDE_USER'	=> '<strong>Odobratý používateľ z banu</strong> z dôvodu „<em>%1$s</em>“<br />» %2$s',
	...
	'LOG_BAN_USER'			=> '<strong>Zabanovaný používateľ</strong> z dôvodu „<em>%1$s</em>“<br />» %2$s',
	...
	'LOG_UNBAN_USER'		=> '<strong>používateľ odbanovaný</strong><br />» %s',
	...
	'LOG_BUMP_TOPIC'			=> '<strong>používateľom oživená téma</strong><br />» %s',
	'LOG_DELETE_POST'			=> '<strong>Odstránený príspevok „%1$s“ napísaný používateľom “%2$s” z nasledujúcich dôvodov</strong><br />» %3$s',
	'LOG_DELETE_SHADOW_TOPIC'	=> '<strong>Odstránená tieňová téma</strong><br />» %s',
	'LOG_DELETE_TOPIC'			=> '<strong>Odstránená téma „%1$s“ napísaný používateľom “%2$s” z nasledujúcich dôvodov</strong><br />» %3$s',
	...
	'LOG_MOVED_TOPIC'			=> '<strong>Presunutá téma</strong><br />» %s',
	...
	'LOG_POST_DISAPPROVED'		=> '<strong>Odmietnutý príspevok „%1$s“ napísaný používateľom “%3$s” z nasledujúceho dôvodu</strong><br />» %2$s',
	'LOG_POST_EDITED'			=> '<strong>Upravený príspevok „%1$s“ napísaný používateľom “%2$s” z nasledujúcich dôvodov</strong><br />» %3$s',
	'LOG_POST_RESTORED'			=> '<strong>Príspevok obnovený</strong><br />» %s',
	'LOG_REPORT_CLOSED'			=> '<strong>Uzavreté hlásenie</strong><br />» %s',
	'LOG_REPORT_DELETED'		=> '<strong>Odstránené hlásenie</strong><br />» %s',
	'LOG_RESTORE_TOPIC'			=> '<strong>Téma “%1$s” obnovená, napísaná používateľom</strong><br />» %2$s',
	'LOG_SOFTDELETE_POST'		=> '<strong>Jemne vymazaný príspevok “%1$s” napísaný používateľom “%2$s” pre nasledujúce dôvody</strong><br />» %3$s',
	'LOG_SOFTDELETE_TOPIC'		=> '<strong>Jemne vymazaná téma “%1$s” napísaná používateľom “%2$s” pre nasledujúce dôvody</strong><br />» %3$s',
	...
	'LOG_TOPIC_RESTORED'		=> '<strong>Téma obnovená</strong><br />» %s',
	'LOG_TOPIC_DISAPPROVED'		=> '<strong>Odmietnutá téma „%1$s“ napísaná používateľom “%3$s” z nasledujúceho dôvodu</strong><br />%2$s',
	...
	'LOG_DISALLOW_ADD'		=> '<strong>Pridané zakázané používateľské meno</strong><br />» %s',
	'LOG_DISALLOW_DELETE'	=> '<strong>Odstránené zakázané používateľské meno</strong>',
	...
	'LOG_GROUP_CREATED'		=> '<strong>Vytvorená nová používateľská skupina</strong><br />» %s',
	'LOG_GROUP_DEFAULTS'	=> '<strong>Skupina „%1$s“ nastavená ako prednastavená pre používateľov</strong><br />» %2$s',
	'LOG_GROUP_DELETE'		=> '<strong>používateľská skupina odstránená</strong><br />» %s',
	'LOG_GROUP_DEMOTED'		=> '<strong>Lídri skupiny degradovaní</strong> %1$s<br />» %2$s',
	'LOG_GROUP_PROMOTED'	=> '<strong>Užívatelia povýšení na lídrov používateľskej skupiny</strong> %1$s<br />» %2$s',
	'LOG_GROUP_REMOVE'		=> '<strong>Užívatelia odstránení z používateľskej skupiny</strong> %1$s<br />» %2$s',
	'LOG_GROUP_UPDATED'		=> '<strong>Upravené detaily o používateľskej skupine</strong><br />» %s',
	'LOG_MODS_ADDED'		=> '<strong>Pridaní noví lídri používateľskej skupiny</strong> %1$s<br />» %2$s',
	'LOG_USERS_ADDED'		=> '<strong>Pridaní noví užívatelia do používateľskej skupiny</strong> %1$s<br />» %2$s',
	'LOG_USERS_APPROVED'	=> '<strong>Užívatelia prijatí do používateľskej skupiny</strong> %1$s<br />» %2$s',
	...
	'LOG_INACTIVE_REMIND'	=> '<strong>Odoslané pripomienkové e-maily pre neaktívnych používateľov</strong><br />» %s',
	'LOG_INSTALL_CONVERTED'	=> '<strong>Prechod z %1$s na phpBB %2$s</strong>',
	'LOG_INSTALL_INSTALLED'	=> '<strong>Inštalácia phpBB %s</strong>',

	'LOG_IP_BROWSER_FORWARDED_CHECK'	=> '<strong>Zlyhala kontrola session IP/prehliadača/X_FORWARDED_FOR</strong><br />»používateľská IP <em>%1$s</em>“ porovnaná s IP session „<em>%2$s</em>“, používateľské označenie prehliadača „<em>%3$s</em>“ porovnané s označením prehliadača session „<em>%4$s</em>“ a používateľský reťazec X_FORWARDED_FOR „<em>%5$s</em>“ porovnaný so session X_FORWARDED_FOR reťazcom „<em>%6$s</em>“.',
	...
	'LOG_U_ROLE_ADD'		=> '<strong>používateľská rola pridaná</strong><br />» %s',
	'LOG_U_ROLE_EDIT'		=> '<strong>používateľská rola upravená</strong><br />» %s',
	'LOG_U_ROLE_REMOVED'	=> '<strong>používateľská rola odstránená</strong><br />» %s',

	'LOG_PLUPLOAD_TIDY_FAILED'		=> '<strong>Nebolo možné otvoriť %1$s pre vyčistenie, skontrolujte oprávnenia.</strong><br />Výnimka: %2$s<br />Cesta: %3$s',
	...
	'LOG_PRUNE_SHADOW'		=> '<strong>Automaticky vyčistené tieňové témy</strong><br />» %s',
	...
	'LOG_RESET_ONLINE'			=> '<strong>Resetovaný rekord online používateľov</strong>',
	'LOG_RESYNC_FILES_STATS'	=> '<strong>Štatistiky súborov resynchronizované</strong>',
	'LOG_RESYNC_POSTCOUNTS'		=> '<strong>Resynchonizácia počtu používateľských príspevkov</strong>',
	'LOG_RESYNC_POST_MARKING'	=> '<strong>Označené témy synchronizované</strong>',
	'LOG_RESYNC_STATS'			=> '<strong>Príspevky, témy a štatistiky používateľov resynchronizované</strong>',
	...
	'LOG_SPHINX_ERROR'			=> '<strong>Sphinx chyba</strong><br />» %s',
	...
	'LOG_THEME_EDIT'			=> '<strong>Editovaná téma <em>%1$s</em></strong>',
	...
	'LOG_USER_ACTIVE'		=> '<strong>používateľ aktivovaný</strong><br />» %s',
	'LOG_USER_BAN_USER'		=> '<strong>Zabanovaný používateľ cez správu používateľov</strong> z dôvodu „<em>%1$s</em>“<br />» %2$s',
	'LOG_USER_BAN_IP'		=> '<strong>Zabanovaná IP cez správu používateľov</strong> z dôvodu „<em>%1$s</em>“<br />» %2$s',
	'LOG_USER_BAN_EMAIL'	=> '<strong>Zabanovaný email cez správu používateľov</strong> z dôvodu „<em>%1$s</em>“<br />» %2$s',
	'LOG_USER_DELETED'		=> '<strong>Zmazaný používateľ</strong><br />» %s',
	'LOG_USER_DEL_ATTACH'	=> '<strong>Odstránené všetky prílohy od používateľa</strong><br />» %s',
	'LOG_USER_DEL_AVATAR'	=> '<strong>Odstránený používateľský avatar</strong><br />» %s',
	'LOG_USER_DEL_OUTBOX'	=> '<strong>Vyprázdnená zložka správ na odoslanie používateľa</strong><br />» %s',
	'LOG_USER_DEL_POSTS'	=> '<strong>Odstránené všetky príspevky od používateľa</strong><br />» %s',
	'LOG_USER_DEL_SIG'		=> '<strong>Odstránený podpis používateľa</strong><br />» %s',
	'LOG_USER_INACTIVE'		=> '<strong>používateľ deaktivovaný</strong><br />» %s',
	'LOG_USER_MOVE_POSTS'	=> '<strong>Presunuté používateľské príspevky</strong><br />» príspevky od „%1$s“ do fóra „%2$s“',
	'LOG_USER_NEW_PASSWORD'	=> '<strong>Zmenené heslo používateľa</strong><br />» %s',
	'LOG_USER_REACTIVATE'	=> '<strong>Nútená reaktivácia používateľského účtu</strong><br />» %s',
	'LOG_USER_REMOVED_NR'	=> '<strong>Odstranené označenie „Nový člen fóra“ u používateľa</strong><br />» %s',

	'LOG_USER_UPDATE_EMAIL'	=> '<strong>používateľ „%1$s“ zmenil e-mail</strong><br />» z „%2$s“ na „%3$s“',
	'LOG_USER_UPDATE_NAME'	=> '<strong>Zmenené používateľské meno</strong><br />» z „%1$s“ na „%2$s“',
	'LOG_USER_USER_UPDATE'	=> '<strong>Aktualizácia detailov používateľa</strong><br />» %s',

	'LOG_USER_ACTIVE_USER'		=> '<strong>používateľský účet aktivovaný</strong>',
	'LOG_USER_DEL_AVATAR_USER'	=> '<strong>Odstránený avatar používateľa</strong>',
	'LOG_USER_DEL_SIG_USER'		=> '<strong>Odstránený podpis používateľa</strong>',
	'LOG_USER_FEEDBACK'			=> '<strong>Pridaná spätná väzba k používateľovi</strong><br />» %s',
	'LOG_USER_GENERAL'			=> '<strong>Pridaný záznam:</strong><br />» %s',
	'LOG_USER_INACTIVE_USER'	=> '<strong>Deaktivácia používateľského účtu</strong>',
	'LOG_USER_LOCK'				=> '<strong>používateľ zamkol svou tému</strong><br />» %s',
	'LOG_USER_MOVE_POSTS_USER'	=> '<strong>Všetky príspevky presunuté do fóra „%s“</strong>',
	'LOG_USER_REACTIVATE_USER'	=> '<strong>Nútená reaktivácia používateľského účtu</strong>',
	'LOG_USER_UNLOCK'			=> '<strong>používateľ odomkol svou tému</strong><br />» %s',
	'LOG_USER_WARNING'			=> '<strong>Pridané varovanie používateľovi</strong><br />» %s',
	'LOG_USER_WARNING_BODY'		=> '<strong>používateľovi bolo udelené následovné varovanie</strong><br />» %s',

	'LOG_USER_GROUP_CHANGE'			=> '<strong>používateľ zmenil prednastavenú skupinu</strong><br />» %s',
	'LOG_USER_GROUP_DEMOTE'			=> '<strong>používateľ zosadený z líderstva skupiny</strong><br />» %s',
	'LOG_USER_GROUP_JOIN'			=> '<strong>používateľ vstúpil do skupiny</strong><br />» %s',
	'LOG_USER_GROUP_JOIN_PENDING'	=> '<strong>používateľ vstúpil do skupiny a čaká na schválenie</strong><br />» %s',
	'LOG_USER_GROUP_RESIGN'			=> '<strong>používateľ vystúpil zo skupiny</strong><br />» %s',

	'LOG_WARNING_DELETED'		=> '<strong>Odstránené varovanie používateľa</strong><br />» %s',
	'LOG_WARNINGS_DELETED'		=> array(
		1 => '<strong>Odstránené varovanie používateľa</strong><br />» %1$s',
		2 => '<strong>Odstránené %2$d varovania používateľa</strong><br />» %1$s', // Example: '<strong>Deleted 2 user warnings</strong><br />» username'
		3 => '<strong>Odstránených %2$d varovaní používateľa</strong><br />» %1$s',
	),
	'LOG_WARNINGS_DELETED_ALL'	=> '<strong>Odstránené všetky varovania používateľa</strong><br />» %s',
