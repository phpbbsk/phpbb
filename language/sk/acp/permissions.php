...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Pre ďalšie informácie o nastavení a správe oprávnení na vašom phpBB3 fóre, prosíme, pozrite sa do <a href="https://www.phpbb.com/support/docs/en/3.1/ug/quickstart/permissions/">Kapitoly Nastavenie oprávnení v Sprievodcovi pre rýchly začiatok</a>.</p>
	',

	'ACL_NEVER'				=> 'Nikdy',
	'ACL_SET'				=> 'Nastavenie oprávnení',
	'ACL_SET_EXPLAIN'		=> 'Oprávnenia sú založené na jednoduchom <strong>ÁNO</strong>/<strong>NIE</strong> systéme. Nastavením možnosti <strong>NIKDY</strong> sa užívateľovi alebo užívateľskej skupine prepíšu všetky iné hodnoty, ktoré sú k danému oprávneniu zaznačené. Pokiaľ si neprajete pre užívateľa, alebo skupinu priradiť hodnotu k danej možnosti, nastavte položku na <strong>NIE</strong>. K sú hodnoty pre túto možnosť označené inde, tamtie budú použité prednostne, ináč je predpokladaná možnosť <strong>NIKDY</strong>. Všetky označené objekty (s checkboxom pred nimi) budú kopírovať sadu oprávnení, ktoré ste tu definovali.',
	...
	'ROLE_DESCRIPTION_FORUM_NEW_MEMBER'		=> 'Role pre skupinu novo registrovaných užívateľov; obsahuje oprávnenie typu <strong> NIKDY </strong> pre obmedzenie možností pre nových užívateľov.',
	...
	'ROLE_DESCRIPTION_USER_NEW_MEMBER'		=> 'Role pro skupinu novo registrovaných užívateľov; obsahuje oprávnenia typu <strong>NIKDY</strong> pre obmedzenie možností pre nových užívateľov.',
	...
	'TRACE_GROUP_NEVER_TOTAL_YES'	=> 'Oprávnenie tejto skupiny je nastavené na <strong>NIKDY</strong>, čo zmení nastavenie oprávnení pre tohoto užívateľa z <strong>ÁNO</strong> na <strong>NIKDY</strong>',
	'TRACE_GROUP_NEVER_TOTAL_YES_LOCAL'	=> 'Oprávnenie tejto skupiny pre toto fórum je nastavené na <strong>NIKDY</strong>, čo zmení nastavenie oprávnenia pre tohto užívateľa z <strong>ÁNO</strong> na <strong>NIKDY</strong>.',
	...
	'TRACE_USER_FOUNDER'					=> 'Tento užívateľ je zakladateľ, teda oprávnenia administrátora sú vždy nastavené na <strong>ÁNO</strong>.',
	'TRACE_USER_KEPT'						=> 'Oprávnenie užívateľa je nastavené na <strong>NIE</strong>, pôvodná hodnota je teda ponechaná.',
	'TRACE_USER_KEPT_LOCAL'					=> 'Oprávnenie užívateľa pre toto fórum je nastavené na <strong>NIE</strong>, pôvodná hodnota je teda ponechaná.',
	'TRACE_USER_NEVER_TOTAL_NEVER'			=> 'Oprávnenie užívateľa je nastavené na <strong>NIKDY</strong> a výsledná hodnota je nastavená na <strong>NIKDY</strong>, nič sa teda nemení.',
	'TRACE_USER_NEVER_TOTAL_NEVER_LOCAL'	=> 'Oprávnenie užívateľa pre toto fórum je nastavené na <strong>NIKDY</strong> a výsledná hodnota je nastavená na <strong>NIKDY</strong>, nič se teda nemení.',
	'TRACE_USER_NEVER_TOTAL_NO'				=> 'Oprávnenie užívateľa je nastavené na <strong>NIKDY</strong>, čo sa stáva výslednou hodnotou, pretože bolo doteraz nastavené len na NIE.',
	'TRACE_USER_NEVER_TOTAL_NO_LOCAL'		=> 'Oprávnenie užívateľa pre toto fórum je nastavené na <strong>NIKDY</strong>, čo sa stáva výslednou hodnotou, pretože bolo doteraz nastavená len na NIE.',
	'TRACE_USER_NEVER_TOTAL_YES'			=> 'Oprávnenie užívateľa je nastavené na <strong>NIKDY</strong> a nahradzuje predošlú hodnotu <strong>ÁNO</strong>.',
	'TRACE_USER_NEVER_TOTAL_YES_LOCAL'		=> 'Oprávnenie užívateľa pre toto fórum je nastavené na <strong>NIKDY</strong> a nahradzuje predošlú hodnotu <strong>ÁNO</strong>.',
	'TRACE_USER_NO_TOTAL_NO'				=> 'Oprávnenie užívateľa je nastavené na <strong>NIE</strong> a výsledná hodnota už obsahuje <strong>NIE</strong>, hodnota sa teda mení na <strong>NIKDY</strong>.',
	'TRACE_USER_NO_TOTAL_NO_LOCAL'			=> 'Oprávnenie užívateľa pre toto fórum je nastavené na <strong>NIE</strong> a výsledná hodnota už obsahuje NIE, hodnota sa teda mení na <strong>NIKDY</strong>.',
	'TRACE_USER_YES_TOTAL_NEVER'			=> 'Oprávnenie užívateľa je nastavené na <strong>ÁNO</strong>, ale výsledné oprávnenie nastavené na <strong>NIKDY</strong> sa nedá prepísať.',
	'TRACE_USER_YES_TOTAL_NEVER_LOCAL'		=> 'Oprávnenie užívateľa pre toto fórum je nastavené na <strong>ÁNO</strong>, ale výsledné oprávnenie nastavené na <strong>NIKDY</strong> sa nedá prepísať.',
	'TRACE_USER_YES_TOTAL_NO'				=> 'Oprávnenie užívateľa je nastavené na <strong>ÁNO</strong>, čo sa stáva novou výslednou hodnotou, pretože posledná nastavená hodnota bola <strong>NIE</strong>.',
	'TRACE_USER_YES_TOTAL_NO_LOCAL'			=> 'Oprávnenie užívateľa pre toto fórum je nastavené na <strong>ÁNO</strong>, čo sa stáva novou výslednou hodnotou, pretože posledná nastavená bola <strong>NIE</strong>.',
	'TRACE_USER_YES_TOTAL_YES'				=> 'Oprávnenie užívateľa je nastavené na <strong>ÁNO</strong> a výsledná hodnota je nastavená na <strong>ÁNO</strong>, nič sa teda nemení.',
	'TRACE_USER_YES_TOTAL_YES_LOCAL'		=> 'Oprávnenie užívateľa pre toto fórum je nastavené na <strong>ÁNO</strong> a výsledná hodnota je nastavená na <strong>ÁNO</strong>, nič se teda nemení.',
	'TRACE_WHO'								=> 'Kto',
