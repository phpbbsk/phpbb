...
$lang = array_merge($lang, array(
	...
	'AUTO_PRUNE_SHADOW_FREQ'	=> 'Frekvencia automatického prečistenia tieňových tém',
	'AUTO_PRUNE_SHADOW_DAYS'	=> 'Vek tieňových tém na automatické prečistenie',
	'AUTO_PRUNE_SHADOW_DAYS_EXPLAIN'	=> 'Počet dní, po ktorých bude tieňová téma odstránená.',
	'AUTO_PRUNE_SHADOW_FREQ_EXPLAIN'	=> 'Čas v dňoch medzi jednotlivými prečisteniami.',
	...
	'ENABLE_QUICK_REPLY_EXPLAIN'	=> 'Povolí rýchlu odpoveď na tomto fóre. Toto nastavenie nie je brané do ohľadu, ak je rýchla odpoveď vypnutá všeobecne. Rýchla odpoveď bude zobrazená iba tým používateľom, ktorí majú oprávnenie prispievať v tomto fóre.',
	...
	'FORUM_DESC'						=> 'Popis',
	'FORUM_DESC_EXPLAIN'				=> 'Žiadna HTML značka, ktorá sem bude zadaná, nebude spracovaná. Ak je typ fóra nastavený na kategóriu, popis nie je použitý nikde.',
	'FORUM_EDIT_EXPLAIN'				=> 'Tento formulár vám umožní prispôsobiť fórum. Prosím, uvedomte si však, že nastavenie moderátorov a počítanie príspevkov sa musí nastaviť cez Oprávnenia pre fóra pre jednotlivých používateľov, alebo skupiny.',
	...
	'FORUM_LINK_EXPLAIN'				=> 'Úplná adresa URL (vrátane protokolu, napríklad <samp>http://</samp>), kam bude používateľ po kliknutí presmerovaný, napr.: <samp>http://www.phpbb.com/</samp>.',
	...
	'FORUM_PRUNE_SHADOW'				=> 'Povoliť automatické prečistenie tieňových tém',
	'FORUM_PRUNE_SHADOW_EXPLAIN'			=> 'Prečistí fórum od tieňových tém. Nižšie nastavte frekvenciu/vek.',
