...
$lang = array_merge($lang, array(
	'ACP_GROUPS_MANAGE_EXPLAIN'		=> 'Z tohto panela môžete ovládať všetky vaše používateľské skupiny. Môžete mazať, vytvárať a upravovať existujúce skupiny. Navyše môžete zvoliť lídrov skupiny, meniť status skupiny (otvorená/skrytá/uzavretá) a nastaviť meno a popis skupiny.',
	'ADD_GROUP_CATEGORY'			=> 'Pridať kategóriu',
	'ADD_USERS'						=> 'Pridať používateľov',
	'ADD_USERS_EXPLAIN'				=> 'Tu môžete pridať nových používateľov do skupiny. Môžete vybrať, či sa skupina stane pre používateľa predvolená. Taktiež ich môžete definovať ako lídrov skupiny. Prosíme, napíšte každé meno do nového riadka.',
	...
	'GROUP_CATEGORY_NAME'			=> 'Názov kategórie',
	'GROUP_CLOSED'					=> 'Uzavretá',
	'GROUP_COLOR'					=> 'Farba skupiny',
	'GROUP_COLOR_EXPLAIN'			=> 'Definuje, v ktorej farbe sa budú zobrazovať používateľské mená členov, nechajte prázne, aby sa zobrazovala predvolená používateľská farba.',
	'GROUP_CONFIRM_ADD_USERS'		=> array(
		1	=> 'Ste si istý, že chcete pridať používateľa %2$s do skupiny?',
		2	=> 'Ste si istý, že chcete pridať používateľov %2$s do skupiny?',
		3	=> 'Ste si istý, že chcete pridať používateľov %2$s do skupiny?',
	),
	'GROUP_CREATED'					=> 'Skupina bola úspešne vytvorená.',
	'GROUP_DEFAULT'					=> 'Nastaviť skupinu pre člena ako predvolenú',
	'GROUP_DEFS_UPDATED'			=> 'Pre vybraných používateľov bola skupina nastavená ako predvolená.',
	...
	'GROUP_EDIT_EXPLAIN'			=> 'Tu môžete upravovať existujúcu skupinu. Môžete zmeniť názov, popis a typ (otvorená, uzavretá, atď.). Môžete tiež zmeniť niektoré skupinové nastavenia ako farbu, hodnosť a pod. Zmena týchto nastavení prepíše používateľove nastavenia. Prosíme, uvedomte si, že kým nenastavíte potrebné používateľské oprávnenia, členovia skupiny môžu obísť nastavenia skupinového avatara.',
	...
	'GROUP_MEMBERS_EXPLAIN'			=> 'Toto je kompletný zoznam členov tejto používateľskej skupiny. To zahrňuje oddelené sekcie pre lídrov, čakajúcich a existujúcich členov. Tu môžete upravovať všetky aspekty toho, kto má členstvo v tejto skupine a aká je ich rola. Pre zrušenie lídra skupiny, no jeho ponechanie v skupine použite radšej možnosť degradovať lídra skupiny namiesto vymazania. Podobne môžete použiť funkciu Povýšiť na lídra skupiny.',
	'GROUP_MESSAGE_LIMIT'			=> 'Limit súkromných správ skupiny na zložku',
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> 'Toto nastavenie prepíše nastavenie súkromých správ na zložku pre jednotlivých používateľov. Hodnota 0 znamená, že sa použije predvolená hodnota pre používateľa.',
	...
	'GROUP_SPECIAL'					=> 'Preddefinovaná',
	'GROUP_TEAMPAGE'				=> 'Zobraziť skupinu na stránke tímu',
	...
	'NO_GROUPS_ADDED'			=> 'Zatiaľ neboli pridané žiadne skupiny.',
	'NO_GROUPS_CREATED'			=> 'Zatiaľ neboli vytvorené žiadne skupiny.',
	'NO_PERMISSIONS'			=> 'Nekopírovať oprávnenia',
	'NO_USERS'					=> 'Nevložili ste žiadnych používateľov.',
	'NO_USERS_ADDED'			=> 'Žiadni užívatelia neboli pridaní do skupiny.',
	'NO_VALID_USERS'			=> 'Nevložili ste žiadneho používateľa vhodného pre požadovanú akciu.',

	'PENDING_MEMBERS'			=> 'Čakajúci',

	'SELECT_GROUP'				=> 'Vybrať skupinu',
	'SPECIAL_GROUPS'			=> 'Preddefinované skupiny',
	'SPECIAL_GROUPS_EXPLAIN'	=> 'Preddefinované skupiny sú špeciálne skupiny, nemôžu byť zmazané, alebo priamo upravované. Môžete však pridávať používateľov a meniť základné nastavenia.',
	...
	'USER_DEFAULT'					=> 'Prednastavená pre používateľa',
	'USER_DEF_GROUPS'				=> 'Skupiny definované používateľom',
	...
	'USER_GROUP_DEFAULT_EXPLAIN'	=> 'Vybraním tejto možnosti, nastavíte danú skupinu ako prednastavenú pre vybraných používateľov.',
