...
$lang = array_merge($lang, array(
	...
	'DELETE_IMAGESET_EXPLAIN'	=> 'Tu môžete odstrániť vybranú sadu obrázku z databázy. Ďalej, pokiaľ ste k tomu oprávnený, môžete ju odstrániť aj zo súborového systému. Majte na vedomí, že toto nejde vrátiť. Akonáhle je sada odstránená, už ju nevrátite. Doporučujeme najskôr urobiť export do archívu pre neskoršie použitia.',
	'DELETE_STYLE'	=> 'Odstrániť štýl',
	'DELETE_STYLE_EXPLAIN'	=> 'Tu môžete odstrániť vybraný štýl. Nedajú sa tu však odstrániť jeho súčasti, tie musíte odstrániť každú zvlášť v odpovedajúcich sekciách. Odstránenie štýlu je trvalé a nedá sa vrátiť späť.',
	'DELETE_TEMPLATE'	=> 'Odstrániť template',
	'DELETE_TEMPLATE_EXPLAIN'	=> 'Tu môžete odstrániť vybranú sadu šablón z databázy. Ďalej, pokiaľ ste k tomu oprávnený, môžete ju odstrániť aj zo súborového systému. Majte na vedomí, že toto nejde vrátiť. Akonáhle je sada odstránená, už ju nevrátite. Odporúčame najskôr urobiť export do archívu pre neskoršie použitia.',
	'DELETE_THEME'	=> 'Odstrániť skin',
	'DELETE_THEME_EXPLAIN'	=> 'Tu môžete odstrániť vybraný skin z databázy. Ďalej, pokiaľ ste k tomu oprávnený, môžete ho odstrániť aj zo súborového systému. Majte na vedomí, že toto nejde vrátiť. Akonáhle je skin odstránený, už ju nevrátite. Odporúčame najskôr urobiť export do archívu pre neskoršie použitia.',
	'DETAILS'	=> 'Detaily',
	...
	'IMG_FORUM_UNREAD'	=> 'Nové príspevky vo fóre',
	'IMG_FORUM_UNREAD_LOCKED'	=> 'Nové príspevky vo fóre - zamknuté',
	'IMG_FORUM_UNREAD_SUBFORUM'	=> 'Nové príspevky v subfóre',
	'IMG_SUBFORUM_READ'			=> 'Ikona subfóra',
	'IMG_SUBFORUM_UNREAD'		=> 'Ikona subfóra s novými príspevkami',
	...
	'IMG_TOPIC_UNREAD'	=> 'Téma s novými príspevkami',
	'IMG_TOPIC_UNREAD_MINE'	=> 'Oznámenie s vlastnými a novými príspevkami',
	'IMG_TOPIC_UNREAD_HOT'	=> 'Obľúbená téma s novými príspevkami',
	'IMG_TOPIC_UNREAD_HOT_MINE'	=> 'Obľúbená téma s vlastnými a novými príspevkami',
	'IMG_TOPIC_UNREAD_LOCKED'	=> 'Nová zamknutá téma',
	'IMG_TOPIC_UNREAD_LOCKED_MINE'	=> 'Zamknutá téma s vlastnými a novými príspevkami',
	...
	'IMG_STICKY_UNREAD'	=> 'Oznámenie s novými príspevkami',
	'IMG_STICKY_UNREAD_MINE'	=> 'Oznámenie s vlastnými a novými príspevkami',
	'IMG_STICKY_UNREAD_LOCKED'	=> 'Zamknuté oznámenie s novými príspevkami',
	'IMG_STICKY_UNREAD_LOCKED_MINE'	=> 'Zamknuté oznámenie s vlastnými a novými príspevkami',
	...
	'IMG_ANNOUNCE_UNREAD'	=> 'Dôležité s novými príspevkami',
	'IMG_ANNOUNCE_UNREAD_MINE'	=> 'Dôležité s novými a vlastnými príspevkami',
	'IMG_ANNOUNCE_UNREAD_LOCKED'	=> 'Zamknuté dôležité s novými príspevkami',
	'IMG_ANNOUNCE_UNREAD_LOCKED_MINE'	=> 'Zamknuté dôležité s novými a vlastnými príspevkami',
	...
	'IMG_GLOBAL_UNREAD'	=> 'Globálne s novými príspevkami',
	'IMG_GLOBAL_UNREAD_MINE'	=> 'Globálne s vlastnými a novými príspevkami',
	'IMG_GLOBAL_UNREAD_LOCKED'	=> 'Zamknuté globálne s novými príspevkami',
	'IMG_GLOBAL_UNREAD_LOCKED_MINE'	=> 'Zamknuté globálne s vlastnými a novými príspevkami',
