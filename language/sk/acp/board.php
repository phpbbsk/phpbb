...
$lang = array_merge($lang, array(
	...
	'DEFAULT_STYLE_EXPLAIN'			=> 'Predvolený vzhľad pre nových užívateľov.',
...
$lang = array_merge($lang, array(	
	...
	'COOKIE_PATH_EXPLAIN'		=> 'Uvedomte si, že toto je vždy lomítko, nezáleží na URL adrese fóra.',
...
$lang = array_merge($lang, array(
	...
	'CONTACT_US_ENABLE_EXPLAIN'		=> 'Táto stránka povoľuje užívateľom poslať email administrátorom fóra',
...
$lang = array_merge($lang, array(
	...
	'SMTP_ALLOW_SELF_SIGNED_EXPLAIN'=> 'Povolí pripojenia na SMTP server so samo-podpísaným SSL certifikátom.<em><strong>Varovanie:</strong> Povolenie samo-podpísaných SSL certifikátov môže spôsobiť bezpečnostné problémy.</em>',
	...
	'SMTP_SERVER_EXPLAIN'			=> 'Uvedomte si, prosím, že budete musiť poskytnúť protokol, ktorý váš server používa. Ak používate SSL, musíte uviesť "ssl://your.mailserver.com"',
	...
	'SMTP_VERIFY_PEER_EXPLAIN'		=> 'Požadovať verifikáciu SLL certifikátu pri používaní SMTP servera.<em><strong>Varovanie:</strong> Pripájanie peerov s neverifikovanými SSL certifikátmi môže mať bezpečnostné dôsledky.</em>',
	'SMTP_VERIFY_PEER_NAME'			=> 'Overiť SMTP peer meno',
	'SMTP_VERIFY_PEER_NAME_EXPLAIN'	=> 'Požadovať verifikáciu peer mena SMTP serverov použitím SSL / TLS pripojenia.<em><strong>Varovanie:</strong> Pripájanie peerov s neverifikovanými SSL certifikátmi môže mať bezpečnostné dôsledky.</em>',
...
$lang = array_merge($lang, array(
	...
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'Povoliť pripojenia na Jabber server so samo-podpísaným SSL certifikátom.<em><strong>Varovanie:</strong> Povolenie samo-podpísaných SSL certifikátov môže mať bezpečnostné dôsledky.</em>',
	...
	'JAB_VERIFY_PEER_EXPLAIN'		=> 'Požadovať overovanie SSL certifikátu pri používaní Jabber servera.<em><strong>Varovanie:</strong> Pripájanie peerov s neovereným SSL certifikátom môže mať bezpečnostné dôsledky.</em>',
	'JAB_VERIFY_PEER_NAME'			=> 'Overovať Jabber peer meno',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'Požadovať overovanie peer mena Jabber serverov používajúcich SSL / TLS pripojenie.<em><strong>Varovanie:</strong> Pripájanie peerov s neovereným SSL certifikátom môže mať bezpečnostné dôsledky.</em>',
));
