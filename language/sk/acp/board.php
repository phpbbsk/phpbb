...
$lang = array_merge($lang, array(
	...
	'SMTP_PASSWORD_EXPLAIN'			=> 'Heslo zadávaj iba v prípade, že ho tvoj SMTP server vyžaduje.<br /><em><strong>UPOZORNENIE:</strong> Toto heslo bude uložené ako nezakódovaný text, viditeľný pre každého, kto má prístup k vašej databáze alebo kto môže vidieť túto konfiguráciu.</em>',
	'SMTP_PLAIN'					=> 'PLAIN',
